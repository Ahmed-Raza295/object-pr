...
let choseBrand = document.getElementById("choseBrand")
let choseProduct = document.getElementById("choseProduct")
let selectedBrand;
let selectedProduct ;
...
for(let company in watches){
choseBrand.innerHTML += `
...
choseProduct.innerHTML = ''
for(let products in watches[selectedBrand]){
choseProduct.innerHTML +=`
<option value ='${watches[selectedBrand][products].name}'>${watches[selectedBrand][products].name
}</option>
`
}
}
...
for(let variant in watches[selectedBrand]){
if(watches[selectedBrand][variant].name === selectedProduct){
   postImage.setAttribute("src", watches[selectedBrand][variant].img);
   name.innerHTML = watches[selectedBrand][variant].name;
   price.innerHTML = `price : ${watches[selectedBrand][variant].price}`;
   para.innerHTML = watches[selectedBrand][variant].caption;
